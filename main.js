...
const PLANET_FEATURE_CONTENT = {
  sun: {
    title: "태양의 특징",
    intro: "태양은 태양계 질량의 약 99.8%를 차지하는 G형 주계열성으로, 중심 핵융합 반응으로 빛과 열을 지속적으로 방출합니다.",
    facts: [
      ["평균 반지름", "696,340 km"],
      ["질량 비중", "태양계 전체의 약 99.8%"],
      ["광구 온도", "약 5,500°C"],
      ["중심 온도", "약 1,500만°C"],
      ["주성분", "수소, 헬륨"],
      ["자전 주기", "약 25~35일"]
  ...
  mercury: {
    title: "수성의 특징",
    intro: "수성은 태양에 가장 가까운 암석 행성으로, 대기가 거의 없어 표면 환경이 극단적이며 충돌 지형이 잘 보존되어 있습니다.",
    facts: [
      ["평균 반지름", "2,440 km"],
      ["표면 중력", "3.7 m/s²"],
      ["공전 주기", "88일"],
    ...
    sections: [
      { title: "표면과 지형", bullets: ["대기가 희박해 운석 충돌구가 장기간 지워지지 않고 남아 있습니다.", "극지의 영구 음영 크레이터에서는 물 얼음 존재 가능성이 확인되었습니다.", "낮과 밤의 온도 차가 매우 커 열응력에 의한 풍화 특성이 뚜렷합니다."] },
      { title: "내부 구조", bullets: ["행성 크기에 비해 철-니켈 중심핵 비율이 큰 것으로 추정됩니다.", "약하지만 전역 자기장을 보유해 태양풍과 상호작용합니다.", "수축 지형(절벽·단층) 흔적이 내부 냉각 역사를 보여줍니다."] },
      { title: "탐사 포인트", bullets: ["BepiColombo 임무가 궤도 진입 후 표면·자기장·외기권을 정밀 관측할 예정입니다.", "극지 휘발성 물질의 분포는 태양계 내 물 공급 경로 연구에 중요합니다.", "고온·강복사 근접 환경에서 우주선 열제어 기술 검증 대상입니다."] }
    ]
  },
  venus: {
    title: "금성의 특징",
    intro: "금성은 지구와 크기는 비슷하지만 초고밀도 CO2 대기와 강한 온실효과로 표면 환경이 태양계에서 가장 가혹한 행성입니다.",
    facts: [
      ["평균 반지름", "6,052 km"],
      ["표면 중력", "8.87 m/s²"],
      ["표면 압력", "지구의 약 92배"],
    ...
    sections: [
      { title: "대기와 기후", bullets: ["대기의 대부분이 CO2이며 두꺼운 구름층이 열을 가두는 강한 온실효과를 만듭니다.", "상층 대기는 초회전(super-rotation)으로 행성 자전보다 훨씬 빠르게 순환합니다.", "황산 에어로졸 구름이 가시광 관측을 제한해 레이더 탐사가 중요합니다."] },
      { title: "지질 활동", bullets: ["광범위한 화산 지형과 용암 평원이 행성 표면을 덮고 있습니다.", "지구형 판구조와는 다른 열 방출 메커니즘이 작동하는 것으로 보입니다.", "최근 화산 활동 가능성을 시사하는 열·가스 관측 결과가 보고됩니다."] },
      { title: "연구 가치", bullets: ["지구형 행성의 기후 진화를 비교하는 핵심 기준 행성입니다.", "폭주 온실효과 시나리오 연구에 직접적인 단서를 제공합니다.", "고온·고압 환경 탐사 기술 개발에 가장 어려운 시험장입니다."] }
    ]
  },
  earth: {
    title: "지구의 특징",
    intro: "지구는 액체 물, 산소-질소 대기, 자기권, 판구조 운동이 동시에 작동하는 현재까지 확인된 유일한 생명 거주 행성입니다.",
    facts: [
      ["평균 반지름", "6,371 km"],
      ["표면 중력", "9.8 m/s²"],
      ["해양 비율", "약 71%"],
    ...
    sections: [
      { title: "지질과 내부", bullets: ["지각-맨틀-외핵-내핵의 층상 구조와 활발한 내부 열순환을 가집니다.", "판구조 운동이 산맥 형성, 지진, 화산 활동을 유도합니다.", "지표 재순환이 장기 탄소순환과 기후 안정성에 기여합니다."] },
      { title: "대기·해양 시스템", bullets: ["물순환(증발-응결-강수)과 해류가 전지구 열수송을 담당합니다.", "온실기체와 구름 피드백이 복합적으로 기온을 조절합니다.", "자전축 기울기(약 23.5도)가 계절성과 생태 다양성을 만듭니다."] },
      { title: "생명 거주성", bullets: ["자기장이 태양풍을 차폐해 대기 손실과 방사선 노출을 줄입니다.", "달의 존재는 조석과 자전축 안정성 유지에 중요한 역할을 합니다.", "액체 물의 장기 안정성은 복잡한 생태계 진화의 핵심 조건입니다."] }
    ]
  },
  mars: {
    title: "화성의 특징",
    intro: "화성은 얇은 대기와 건조한 환경을 가진 암석 행성이지만, 과거 물 활동 흔적이 풍부해 생명 가능성 탐사의 핵심 목표입니다.",
    facts: [
      ["평균 반지름", "3,390 km"],
      ["표면 중력", "3.71 m/s²"],
      ["대기", "희박한 CO2 중심"],
    ...
    sections: [
      { title: "지형과 물 흔적", bullets: ["올림푸스 몬스(거대 화산), 발레스 마리네리스(거대 협곡) 등 극단적 지형을 가집니다.", "고대 하천·삼각주·퇴적층 관측으로 과거 액체 물 흐름이 강하게 지지됩니다.", "극관의 계절성 변화가 물-CO2 순환 연구의 단서를 제공합니다."] },
      { title: "환경 조건", bullets: ["대기 압력이 낮아 액체 물이 장시간 안정적으로 존재하기 어렵습니다.", "전지구적 먼지폭풍이 발생해 태양광·열수지에 큰 변동을 줍니다.", "방사선 환경이 거칠어 유인 탐사 거주 기술이 필수입니다."] },
      { title: "탐사 로드맵", bullets: ["로버가 유기분자, 광물, 퇴적 구조를 분석해 고환경을 복원합니다.", "화성 시료귀환은 생명 흔적 검증의 결정적 단계로 평가됩니다.", "장기적으로 ISRU(현지자원활용) 기반 유인 탐사 실증이 목표입니다."] }
    ]
  },
  jupiter: {
    title: "목성의 특징",
    intro: "목성은 태양계 최대 가스 거성으로, 강력한 자기권과 복잡한 대기 역학, 거대한 위성계를 동시에 가진 행성입니다.",
    facts: [
      ["평균 반지름", "69,911 km"],
      ["표면 중력", "24.8 m/s²"],
      ["주성분", "수소, 헬륨"],
    ...
    sections: [
      { title: "대기 역학", bullets: ["밝고 어두운 밴드가 강한 제트기류에 의해 형성됩니다.", "대적점은 수세기 이상 지속된 거대 반시계 폭풍으로 알려져 있습니다.", "상층 대기의 암모니아·황화수소 구름 분포가 시간에 따라 변합니다."] },
      { title: "자기권과 복사", bullets: ["매우 강한 자기장이 광범위한 복사대를 형성합니다.", "복사 환경이 강해 탐사선 전자장비 차폐 설계가 중요합니다.", "극지 오로라 관측은 자기권-태양풍 결합을 이해하는 핵심 자료입니다."] },
      { title: "위성계", bullets: ["갈릴레이 위성은 내부 바다, 화산, 얼음지각 등 다양한 지질 환경을 가집니다.", "유로파의 지하 바다는 외계 생명 탐사 유망 후보입니다.", "목성계는 행성 및 위성 형성 이론 검증의 핵심 실험실입니다."] }
    ]
  },
  saturn: {
    title: "토성의 특징",
    intro: "토성은 거대한 고리 구조와 복잡한 위성계를 지닌 가스 거성으로, 입자역학과 행성 대기 연구에서 독보적인 관측 대상입니다.",
    facts: [
      ["평균 반지름", "58,232 km"],
      ["표면 중력", "10.4 m/s²"],
      ["평균 밀도", "물보다 낮음"],
    ...
    sections: [
      { title: "고리 시스템", bullets: ["고리는 얼음·암석 입자들의 얇은 원반 구조로 구성됩니다.", "간극과 파동 구조는 위성 중력 공명과 밀접하게 연결됩니다.", "입자 충돌·응집·분산 과정이 장기 진화를 결정합니다."] },
      { title: "대기와 극지", bullets: ["상층 대기에서 다중 제트기류와 대규모 폭풍이 관측됩니다.", "북극 육각형 제트는 토성 대기역학의 대표적 미해결 현상입니다.", "장주기 공전으로 계절 변화가 느리고 장기 관측 가치가 큽니다."] },
      { title: "주요 위성", bullets: ["타이탄은 두꺼운 질소 대기와 메탄 순환을 가진 지구형 유사 환경을 제공합니다.", "엔셀라두스의 얼음 분출은 지하 바다 존재 가능성을 강하게 시사합니다.", "토성계는 생명 거주 가능성 탐사 후보를 다수 포함합니다."] }
    ]
  },
  uranus: {
    title: "천왕성의 특징",
    intro: "천왕성은 자전축이 크게 기울어진 얼음 거성으로, 태양계에서 가장 독특한 계절 구조와 자기장 기하를 보이는 행성입니다.",
    facts: [
      ["평균 반지름", "25,362 km"],
      ["표면 중력", "8.69 m/s²"],
      ["주성분", "수소, 헬륨, 메탄"],
    ...
    sections: [
      { title: "축 기울기와 계절", bullets: ["자전축이 약 98도 기울어 거의 옆으로 누운 상태로 공전합니다.", "한쪽 극이 수십 년 동안 연속 일조/연속 야간을 겪는 극단적 계절이 나타납니다.", "이 특성은 행성 대기 순환 모델 검증에 매우 중요합니다."] },
      { title: "대기와 내부", bullets: ["메탄 흡수로 적색 파장이 줄어 청록색 외관을 보입니다.", "내부 열 방출이 상대적으로 약해 에너지 수지 연구의 핵심 사례입니다.", "얼음 거성 내부(물·암모니아·메탄 고압상태) 모델이 아직 불확실합니다."] },
      { title: "탐사 필요성", bullets: ["보이저 2호 이후 근접 관측 데이터가 매우 제한적입니다.", "고리·위성·자기권 동시 관측 임무의 과학적 우선순위가 높습니다.", "외계행성 다수와 유사한 얼음 거성 분류 이해에 핵심 기준입니다."] }
    ]
  },
  neptune: {
    title: "해왕성의 특징",
    intro: "해왕성은 태양계 외곽의 얼음 거성으로, 매우 강한 바람과 빠르게 진화하는 대기 구조를 보이는 역동적인 행성입니다.",
    facts: [
      ["평균 반지름", "24,622 km"],
      ["표면 중력", "11.2 m/s²"],
      ["주성분", "수소, 헬륨, 메탄"],
    ...
    sections: [
      { title: "기상 시스템", bullets: ["태양계에서 가장 빠른 수준의 고속 바람이 관측됩니다.", "대흑점류 폭풍 구조가 형성·소멸을 반복하며 대기 변동성이 큽니다.", "상층 구름대와 제트 패턴이 짧은 시간척도에서도 변화합니다."] },
      { title: "내부·자기장", bullets: ["내부 열 방출이 외부 태양복사 대비 커서 대기 활동을 강화합니다.", "자기장이 자전축 대비 크게 기울고 중심에서 치우친 비대칭 구조를 보입니다.", "얼음 거성 내부 조성·대류 메커니즘은 현재도 핵심 연구 주제입니다."] },
      { title: "위성 및 탐사", bullets: ["트리톤은 역행 공전하며 포획 천체일 가능성이 높습니다.", "트리톤의 지질·대기 활동은 카이퍼 벨트 기원 연구와 연결됩니다.", "해왕성계 근접 탐사는 심우주 장기 운용 기술의 중요한 시험 무대입니다."] }
    ]
  },
  pluto: {
    title: "명왕성의 특징",
    intro: "명왕성은 왜소행성이지만 지질학적으로 활발한 얼음 지형과 계절성 대기 변화를 보여, 외곽 태양계 연구에서 매우 중요한 천체입니다.",
    facts: [
      ["평균 반지름", "1,188 km"],
      ["표면 중력", "0.62 m/s²"],
      ["주요 얼음", "질소, 메탄, 일산화탄소"],
    ...
    sections: [
      { title: "표면과 지질", bullets: ["스푸트니크 평원(심장 모양 영역)은 명왕성의 대표 지형입니다.", "질소 얼음 대류 흔적은 작은 천체에서도 지질 활동이 가능함을 보여줍니다.", "지역별 반사율·색상 대비가 매우 커 복합 표면 진화를 시사합니다."] },
      { title: "대기와 계절", bullets: ["희박한 질소 대기는 태양 거리 변화에 따라 팽창·수축합니다.", "장주기 공전으로 계절 변화가 매우 느리고 장기간 지속됩니다.", "얼음 승화·응축 순환이 대기 압력 변동과 직결됩니다."] },
      { title: "과학적 의미", bullets: ["뉴허라이즌스 근접 비행이 외곽 소천체의 복잡성을 입증했습니다.", "카이퍼 벨트 천체 형성·진화 모델의 기준점 역할을 합니다.", "왜소행성 분류 천체의 내부·표면 다양성 연구를 확장합니다."] }
    ]
  }
};
